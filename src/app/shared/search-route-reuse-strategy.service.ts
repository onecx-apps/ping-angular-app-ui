...
import { DefaultRouteReuseStrategy } from './base-route-reuse-strategy.service';
...
export class SearchRouteReuseStrategy extends DefaultRouteReuseStrategy {
  /**
  ...
  override shouldDetach(route: ActivatedRouteSnapshot): boolean {
    let detach: boolean =
      route.root.children[0].routeConfig.path === 'ping-angular-app';
  ...
  override shouldAttach(route: ActivatedRouteSnapshot): boolean {
    ...
    if (canAttach) {
      ...
      let paramsMatch: boolean = this.compareObjects(
        route.params,
        this.storedRoutes[route.routeConfig.path].snapshot.params
      );
      let queryParamsMatch: boolean = this.compareObjects(
        route.queryParams,
        this.storedRoutes[route.routeConfig.path].snapshot.queryParams
      );
